              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href="mailto:info@sneakerhub.com" className="hover:text-primary transition-colors duration-200">
                        info@sneakerhub.com
                      </a>
                    </p>
                  </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-600">Free shipping on orders over $100. Standard delivery takes 3-5 business days.</p>
                </div>
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">Returns & Exchanges</h4>
                  <p className="text-sm text-gray-600">30-day return policy. Items must be in original condition with tags attached.</p>
                </div>
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">Size Guide</h4>
                  <p className="text-sm text-gray-600">Need help finding your size? Check our detailed size guide for accurate measurements.</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-center">
                  <input
                    type="checkbox"
                    id="newsletter"
                    className="rounded border-gray-300 text-primary focus:ring-primary focus:ring-offset-0 mr-3"
                  />
